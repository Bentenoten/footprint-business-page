...
<div class="container vergeet-me-verzoek-page">
  ...
  <div class="row title white">
    <div class="col-xs-offset-0 col-xs-12">
      ...
      <br>
      <p>Door op ‘Ja, vergeet-me verzoek indienen’ wordt direct uw verzoek verzonden naar Coolblue.  </p>
    </div>
  </div>
  ...
  <div class="row options">
    <div class="col-xs-offset-1 col-xs-10">
      <button class="button">Ja, ik wil een vergeet-me verzoek indienen</button>
    </div>
    <div class="col-xs-12 btn-extra white">
      <a href="javascript:history.back()">Geen vergeet-me verzoek indienen</a>
    </div>
  </div>
